# ============================================================
# ===== text_prompts_builder.py – настройки текста для строительного бота =====
# ============================================================

import random

# Системный промпт – строительный эксперт
SYSTEM_PROMPT = (
...
# Списки эмодзи для строительной тематики
EMOJIS_BLOCKS = {
    "header": ["🏗️", "🔨", "🛠️", "📐", "🧱", "⚡"],
    "tips": ["✅", "📌", "🔍", "💡", "⚠️", "⚙️"],
    "discussion": ["💬", "🗣️", "👷", "🤝"],
...
def post_process_text(text):
    if not text or len(text) < 50:
        return None
    # Можно добавить автоматическую вставку хештегов, если их нет
    if "#" not in text:
