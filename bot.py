...
BOT_TOKEN = os.getenv("BOT_TOKEN_NEW")               # Токен Telegram-бота для строительного
VK_TOKEN = os.getenv("VK_TOKEN_BUILDER")             # Токен строительной группы (с правами photos, wall, groups, offline)
VK_GROUP_ID = os.getenv("VK_GROUP_ID_BUILDER")       # -239598146
AGNES_API_KEY = os.getenv("AGNES_API_KEY")
GIGACHAT_API_KEY = os.getenv("GIGACHAT_API_KEY")     # Опционально
PORT = int(os.getenv("PORT", 8082))                  # Уникальный порт
...
log("🚀 Запуск бота для Строительного навигатора (гиперреалистичные картинки)")
...
# ===== ПУБЛИКАЦИЯ В VK (возвращает success, error, photo_upload_success) =====
...
if __name__ == "__main__":
    log("🤖 Бот для Строительного навигатора (с переключением) запущен")
